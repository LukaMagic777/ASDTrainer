...
class model(nn.Module):
    ...
    def createAudioModel(self):
        ...
        self.audioModel = nn.Sequential(
    nn.Conv2d(1, 32, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(32),
    nn.Conv2d(32, 32, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(32),
    nn.Conv2d(32, 32, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(32),
    nn.MaxPool2d((2, 1)),
    nn.Conv2d(32, 64, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(64),
    nn.Conv2d(64, 64, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(64),
    nn.Conv2d(64, 64, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(64),
    nn.MaxPool2d((2, 1)),
    nn.Conv2d(64, 64, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(64),
    nn.Conv2d(64, 64, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(64),
    nn.Conv2d(64, 64, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(64),
    nn.MaxPool2d((2, 1)),
    nn.Conv2d(64, 128, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(128),
    nn.Conv2d(128, 128, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(128),
    nn.Conv2d(128, 128, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(128),
    nn.MaxPool2d((2, 2)),
    nn.Conv2d(128, 128, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(128),
    nn.Conv2d(128, 128, 1, padding=1), nn.ReLU(), nn.BatchNorm2d(128),
