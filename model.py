...
class model(nn.Module):
    ...
    def createVisualModel(self):
        ...
        self.visualModel = nn.Sequential(nn.Conv2d(3, 32 , 3), nn.ReLU(), nn.BatchNorm2d(3), nn.Conv2d(3, 32 , 3), nn.ReLU(), nn.BatchNorm2d(3),nn.Conv2d(3, 32 , 3), nn.ReLU(), nn.BatchNorm2d(3), nn.MaxPool2d(2,(2,2)), nn.Conv2d(32, 64 , 3), nn.ReLU(), nn.BatchNorm2d(32), nn.Conv2d(32, 64 , 3), nn.ReLU(), nn.BatchNorm2d(32),nn.Conv2d(32, 64 , 3), nn.ReLU(), nn.BatchNorm2d(32), nn.MaxPool2d(2,(2,2)), nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64),nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.MaxPool2d(2,(2,2)), nn.Conv2d(64, 128 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64, 128 , 3), nn.ReLU(), nn.BatchNorm2d(64),nn.Conv2d(64, 128 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64,128,3))
    ...
    def createAudioModel(self):
        ...
        self.audioModel = nn.Sequential(nn.Conv2d(1, 32 , 3), nn.ReLU(), nn.BatchNorm2d(1), nn.Conv2d(1, 32 , 3), nn.ReLU(), nn.BatchNorm2d(1),nn.Conv2d(1, 32 , 3), nn.ReLU(), nn.BatchNorm2d(1), nn.MaxPool2d(2,(2,1)), nn.Conv2d(32, 64 , 3), nn.ReLU(), nn.BatchNorm2d(32), nn.Conv2d(32, 64 , 3), nn.ReLU(), nn.BatchNorm2d(32),nn.Conv2d(32, 64 , 3), nn.ReLU(), nn.BatchNorm2d(32), nn.MaxPool2d(2,(2,1)), nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64),nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.MaxPool2d(2,(2,1)), nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64),nn.Conv2d(64, 64 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.MaxPool2d(2,(2,2)), nn.Conv2d(64, 128 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64, 128 , 3), nn.ReLU(), nn.BatchNorm2d(64),nn.Conv2d(64, 128 , 3), nn.ReLU(), nn.BatchNorm2d(64), nn.Conv2d(64,128,3))
